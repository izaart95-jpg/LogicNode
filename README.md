...
**A structured knowledge base covering systems fundamentals, networking, security, IoT, and mobile development.**
...
| Document | Description |
|----------|-------------|
| [Penetration Testing Tools](security/penetration-testing-tools.md) | Nmap, Metasploit, Burp Suite, Hashcat, Aircrack-ng, and 20+ more tools |
...
| Document | Description |
|----------|-------------|
| [ESP32](iot/esp32.md) | Architecture, variants (S2/S3/C3/C6/H2), features, power modes |
| [ESP8266](iot/esp8266.md) | Wi-Fi microcontroller — modules, programming, comparison with ESP32 |
| [Arduino](iot/arduino.md) | Platform overview, boards (Uno/Nano/Mega/Due), programming model |
...
| Document | Description |
|----------|-------------|
| [Termux Setup](mobile/termux-setup.md) | Installation, package management, programming languages, SSH, APIs |
...
| **Total Documents** | 16 |
| **Categories** | 6 |
| **Topics Covered** | Kernels, OS Theory, Networking, Security, IoT, Mobile |
